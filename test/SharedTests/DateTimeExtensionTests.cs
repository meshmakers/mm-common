...
{
    private readonly DateTime _epocDateTime = new(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
    private readonly DateTime _maxDateTimeWithoutMilliSeconds = new(9999, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc);
    private readonly DateTime _maxDateTimeWithoutTicks = new(9999, 12, 31, 23, 59, 59, 999, DateTimeKind.Utc);
    private readonly DateTime _testDateTime = new(2022, 10, 31, 17, 0, 53, 123, DateTimeKind.Utc);
    private readonly DateTime _testDateTimeLocal = new(2022, 12, 31, 23, 59, 59, 999, DateTimeKind.Local);
    private readonly DateTime _testDateTimeOutOfRangeMin = new(1969, 10, 31, 17, 00, 53, 123, DateTimeKind.Utc);
    private readonly DateTime _testDateTimeWithoutMilliSeconds = new(2022, 10, 31, 17, 0, 53, 0, DateTimeKind.Utc);
    ...
    {
        var result = _testDateTimeLocal.ToUtc();
